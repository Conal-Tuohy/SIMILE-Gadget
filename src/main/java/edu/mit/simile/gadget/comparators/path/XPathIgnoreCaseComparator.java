 ...
 *
 */
public class XPathIgnoreCaseComparator implements Comparator {
    
    Comparator next;
    boolean ascending;
    
    public XPathIgnoreCaseComparator(boolean ascending) {
        this.next = null;
        this.ascending = ascending;
    }
    
    public XPathIgnoreCaseComparator(boolean ascending, Comparator next) {
        this.next = next;
        this.ascending = ascending;
    }
